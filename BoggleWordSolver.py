...
def main():
    #print("Hello")
    # initialize game board base on user input
    board= []
    for i in range(0,4):
        # append empty row
        board.append([])
    ...
    # set to store string that match valid words found in the dictionary
    validated = set()

    # call the function findwords function from each grid
    for row in range(0,4):
        for col in range(0,4):
            findWord(board, tree, validated, row, col) 
    
    # print set of valid words
